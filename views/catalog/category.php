...
<?php $activCategory = 'Последние товары'; ?>
<section>
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        ...
                                        <?php if ($categoryId == $categoryItem['id']) $activCategory = $categoryItem['name'];?>
                                    </h4>
                                </div>
                            </div>
                        <?php endforeach; ?>
            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items"><!--features_items-->
                    <h2 class="title text-center"><?php echo $activCategory; ?></h2>
