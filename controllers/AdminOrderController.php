...
class AdminOrderController extends AdminBase
{
     ...
     *
     * @param type $getId <p>id редактируемуго заказа</p>
     */
    public function actionUpdate($getId)
    {
     ...
     *
     * @param type $getId <p>id просматриваемого заказа</p>
     */
    public function actionView($getId)
    {
        $id = (is_array($getId)) ? array_shift($getId) : $getId;
        // Проверка доступа
        self::checkAdmin();
     ...
     *
     * @param type $getId <p>id удаляемого заказа</p>
     */
